...
export default function Home() {
  return (
    <div className="min-h-screen bg-midnight-900 text-white">
      ...
      {/* Hero Section - Problem + Benefit + Outcome */}
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          {/* Social Proof Badge - With Source */}
      ...
      {/* Product Screenshot with Caption */}
      ...
      {/* Social Proof - Testimonials with Context */}
      <section className="py-20 px-6 bg-midnight-800/30">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-midnight-500 text-xs mt-8">
            Reviews collected via in-app feedback
          </p>
        </div>
      </section>

      {/* Pricing - Clear Highlights */}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-b from-camp-500/10 to-transparent border-2 border-camp-500/50 relative">
              ...
              <p className="text-midnight-500 text-xs text-center mt-2">7-day free trial included</p>
            </div>
          ...
          <p className="text-center text-midnight-500 text-sm mt-8">
            All prices in EUR. <span className="text-midnight-400">USD pricing: $9 / $29 / $79</span>
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-xl bg-midnight-800/50 border border-midnight-700/50">
              ...
              <p className="text-midnight-400 text-sm">50 UTM links with short links, basic click analytics, and CSV export. No credit card required, no time limit. It's genuinely free forever.</p>
            </div>
          </div>
        </div>
      </section>
